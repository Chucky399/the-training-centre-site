...
re-synced 31 Jul 2026 after John amended his Arlo T&Cs (VAT now included at 20%, new
"You are Our Customer" section, Exam retake + Free Re-Training definitions, free date
transfer up to 24 hours before Day 1). Privacy page was diffed the same day: unchanged.
...
TERMS = """
      ...
      <dl>
        ...
        <dt>&ldquo;Exam retake&rdquo;</dt><dd>means that, for certain courses, you will have to pay for an additional exam attempt. This is relevant to all IAPP exams, for example.</dd>
        <dt>&ldquo;Free Re-Training&rdquo;</dt><dd>offers are available on all courses. If you fail your exam, attend free training until you pass. Only pay any required exam fees.</dd>
      </dl>
      ...
      <h2>You are Our Customer</h2>
      <p>In order for you to experience what we want you to, we offer free training to any delegate who does not pass their exam on the first attempt. For certain courses however, you may be required to pay for a new exam voucher. If you need to change the dates of your course, we also offer the ability to transfer to another date. You can either do this yourself via the registration confirmation email - it has a &ldquo;transfer to another date/time&rdquo; option, or simply ask us to do this for you. The only ask is that you do this at least 24 hours before the scheduled start date.</p>
      ...
      <p>All Prices include VAT at the current rate of 20%. If the rate of VAT changes between the date of your Order and the date of your payment, we will adjust the rate of VAT that you must pay. Changes in VAT will not affect any Prices where we have already received payment in full from you.</p>
      ...
      <p>You may change the date of your course delivery anytime up to 24 hours before Day 1 of your course commences. You cannot change the date if less than 24 hours but please speak to us if you experience any issues on the day. We are usually happy to make changes on your behalf.</p>
